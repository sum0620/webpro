...
<div class="wrapper">
  <div id="slider">
    <div id="slide-wrapper" class="rounded clear"> 
      ...
      <figure id="slide-2"><a class="view" href="#"><img src="images/demo/slider/6.jpg" alt=""></a>
        <figcaption>
          <h2>Uygulama 2</h2>
          <p><?php
          function cvv(){
           echo" <table border='3'>
  <tr>
    <td bgcolor='black'>Sanal Kart Numarası</td>
    <td>1111 1111 1111 0000</td>
  </tr>
  <tr>
    <td>Son Kullanim Tarihi</td>
    <td>09/27</td>
  </tr>
  <tr>
    <td>CVV</td>
...
cvv();
      ...
      <figure id="slide-3"><a class="view" href="#"><img src="images/demo/slider/3.png" alt=""></a>
        <figcaption>
          ...
          <p>
            <?php
             function satranc($satir=8,$sutun=8){
        ...
        <figcaption>
          ...
          <p>
            ...
            function dolarCevir($tutar){
              $dCevir=$tutar/30;
              echo "Dolar:".number_format($tutar,2,".").$dCevir." $<br>";
            } 
            function euroCevir($tutar){
               $eCevir=$tutar/32;
               echo"Euro:".number_format($tutar,2,".").$eCevir." € <br>";
            }
            function sterlin($tutar){
              $sCevir=$tutar/38;
              echo" Sterlin:".number_format($tutar,2,".").$sCevir."£";
            }
            $tl=3600;
            echo$tl."TL <br>";
            dolarCevir($tl);
